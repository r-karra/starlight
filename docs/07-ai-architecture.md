...
## Purpose
This document outlines the research-oriented AI architecture for Starlight, focusing on agentic assistance and multimodal understanding without overclaiming existing platform capabilities.
