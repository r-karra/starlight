...
## Goals
- Support drafting and summarization in everyday work contexts.
- Improve coordination around calendar, email, and tasks.
...
- Draft an email from a short voice prompt and then edit it on the workstation.
- Turn a conversation note into a project action list with deadlines.

## Constraints
- The system should not replace professional judgment or authorial responsibility.
- Sensitive work content must be handled with appropriate safeguards.
- The experience should avoid overwhelming the user with too many notifications.

## Future work
Future work should measure the impact of the workflow on productivity, communication quality, and task completion rates.

## References
- Productivity and knowledge work research.
- Workflow automation and intelligent assistant literature.
- Communication and calendar coordination studies.
