...
## Goals
- Identify recurring pain points that can be addressed through coordination across devices.
...
- Ask for a low-friction summary of an environment, schedule, or note.

## Constraints
- User needs vary by context, age, ability, and culture.
- Some workflows require better capture quality or more reliable speech recognition.
- The system must remain optional, respectful, and non-intrusive.

## Future work
Future work should develop richer personas and more longitudinal studies to understand how the experience affects attention, confidence, and daily routines.

## References
- Research on task switching and cognitive load.
- Learning science and spaced repetition literature.
- Studies on everyday assistive technology and adaptive reminders.
