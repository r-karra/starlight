...
- Keep the experience grounded in user-selected text sources and preferences.
...
- Review notes or questions from a previous reflection session.
- Use the system to support a personalized study cadence without imposing doctrine.

## Constraints
- The system should not claim authority or present itself as a spiritual arbiter.
- User-selected texts and preferences should remain central.
- The experience should be optional and easy to disable.

## Future work
Future work should explore how reflection support can be integrated respectfully into routines without becoming intrusive or overly prescriptive.

## References
- Human-centered design for reflective and contemplative applications.
- Religious and spiritual computing research.
- Personalization and preference-based assistive systems.
